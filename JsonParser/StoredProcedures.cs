        ...
        public static void addJSONDatas(Data item)
        {
            ...
            using (OracleConnection con = new OracleConnection(connectionString))
            {
                ...
                try
                {
                    ...
                    logger.Debug("Connection to database open...");
                    con.Open();

                    logger.Debug("pkg_upload_proc_utils.addJSONDatas");
                    ...
                    cmdGetOperationStatus.Parameters.Add(CreateOracleParameter("in_origdbtrctryor", OracleDbType.Decimal, item.OrigDbtrCtryoR));
        ...
        public static void sendToOffline()
        {
            ...
            using (OracleConnection con = new OracleConnection(connectionString))
            {
                ...
                try
                {
                    ...
                    logger.Debug("pkg_upload_proc_utils.sendToOffline");
